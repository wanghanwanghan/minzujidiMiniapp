...
class Router extends AbstractRouter
{
    ...
    private function UserRouterV1(RouteCollector $routeCollector)
    {
        ...
        $routeCollector->addGroup('/user',function (RouteCollector $routeCollector) use ($prefix)
        {
            ...
            $routeCollector->addRoute(['GET','POST'],'/delete/order',$prefix.'deleteOrder');//删除订单
            ...
            $routeCollector->addRoute(['GET','POST'],'/autoReg',$prefix.'autoReg');//自动注册
            ...
            $routeCollector->addRoute(['GET','POST'],'/updateOpenId',$prefix.'updateOpenId');
        });
